...
#SBATCH --output=/global/homes/s/sachdeva/scripts/neurocorr/exp10/exp10_pvc11-2_out.o
#SBATCH --error=/global/homes/s/sachdeva/scripts/neurocorr/exp10/exp10_pvc11-2_err.o

srun -n 4096 -c 2 shifter \
    python -u $HOME/noise_correlations/scripts/discrim_null_model_analysis.py \
    --data_path=/global/cscratch1/sd/sachdeva/data/pvc11/monkey2.mat \
